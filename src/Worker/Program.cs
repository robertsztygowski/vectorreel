...
builder.Services.Configure<RepositoryBuildOptions>(builder.Configuration.GetSection("RepositoryBuild"));
...
builder.Services.AddHostedService<RepositoryBuildWorker>();
